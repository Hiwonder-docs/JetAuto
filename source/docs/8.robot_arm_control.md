...
<img class="common_img" src="../_static/media/chapter_8/section_1/image2.jpeg" style="width:500px;" alt="" />
...
<img class="common_img" src="../_static/media/chapter_8/section_1/image3.png" alt="" />
...
<img class="common_img" src="../_static/media/chapter_8/section_1/image4.png" alt="" />
...
① Double-click <img src="../_static/media/chapter_8/section_1/image5.png" /> to open the command line terminal. To adjust the deviation and the position of the robotic arm, first stop the app's auto-start service.

```bash
sudo systemctl stop start_app_node.service
```

② Click-on <img src="../_static/media/chapter_8/section_1/image6.png" /> to launch the PC software.
...
|                           **Icon**                           |                         **Function**                         |
| :----------------------------------------------------------: | :----------------------------------------------------------: |
| <img  src="../_static/media/chapter_8/section_1/image11.png" style="width:1.52639in;height:0.22292in" alt="" /> |                      ID number of servo                      |
| <img  src="../_static/media/chapter_8/section_1/image12.png" style="width:1.25in;height:0.67708in" /> |            Adjust servo position from 0 to 1000.             |
| <img  src="../_static/media/chapter_8/section_1/image13.png" style="width:1.44792in;height:0.28125in" alt="" /> |           Adjust servo deviation from -125 to 125.           |
| <img  src="../_static/media/chapter_8/section_1/image14.png" style="width:0.86389in;height:0.43194in" /> | After setting the robot's position and orientation information for x, y, z, and pitch, execute the movement. |

②：Action list

The running time and servo data of the current action are displayed on the action list.

<img class="common_img" src="../_static/media/chapter_8/section_1/image15.png" alt="" />

|                                                              |                                                              |
| :----------------------------------------------------------: | :----------------------------------------------------------: |
|                           **Icon**                           |                         **Function**                         |
| <img  src="../_static/media/chapter_8/section_1/image16.png" style="width:0.54167in;height:0.21875in" /> |                     Action group number                      |
| <img  src="../_static/media/chapter_8/section_1/image17.png" style="width:0.48958in;height:0.21875in" /> | Running time of the action that is time taken to complete this action |
| <img  src="../_static/media/chapter_8/section_1/image18.png" style="width:0.5in;height:0.21875in" /> | Servo value. Double click the figure below <img  src="../_static/media/chapter_8/section_1/image19.png" style="width:0.80208in;height:0.16667in" alt="" /> to revise. |
...
<tr>
<td><img  src="../_static/media/chapter_8/section_1/image20.png" style="width:1.94514in;height:0.39306in" /></td>
<td>Action running duration time. Directly click <img  src="../_static/media/chapter_8/section_1/image21.png" style="width:0.40139in;height:0.27153in" alt="" /> to modify.</td>
</tr>
<tr>
<td><img  src="../_static/media/chapter_8/section_1/image22.png" style="width:1.94514in;height:0.29653in" /></td>
<td >Total running time taking for all the actions in an action group</td>
</tr>
<tr>
<td><img  src="../_static/media/chapter_8/section_1/image23.png" style="width:1.27083in;height:0.42708in" /></td>
<td>If you click this button, joints of robot become loose, and you can drag servos to design any posture</td>
</tr>
<tr>
<td><img  src="../_static/media/chapter_8/section_1/image24.png" style="width:1.22917in;height:0.41667in" /></td>
<td>Read the servo angle you have designed before. This button should be used with <img  src="../_static/media/chapter_8/section_1/image23.png" style="width:1.27083in;height:0.42708in" /></td>
</tr>
<tr>
<td><img  src="../_static/media/chapter_8/section_1/image25.png" style="width:1.125in;height:0.40625in" /></td>
<td>Add the servo value as a action to the last line of the action list</td>
</tr>
<tr>
<td><img  src="../_static/media/chapter_8/section_1/image26.png" style="width:1.1875in;height:0.48958in" /></td>
<td><p>Delete action: delete the action selected in the action list</p>
<p>Delete all: delete all the action in action list</p></td>
</tr>
<tr>
<td><img  src="../_static/media/chapter_8/section_1/image27.png" style="width:1.15625in;height:0.41667in" /></td>
...
<tr>
<td><img  src="../_static/media/chapter_8/section_1/image28.png" style="width:1.16667in;height:0.42708in" /></td>
...
<tr>
<td><img  src="../_static/media/chapter_8/section_1/image29.png" style="width:1.17708in;height:0.42708in" /></td>
<td>Move the selected action up one line</td>
</tr>
<tr>
<td><img  src="../_static/media/chapter_8/section_1/image30.png" style="width:1.16667in;height:0.42708in" /></td>
<td>Move the selected action down one line</td>
</tr>
<tr>
<td><img  src="../_static/media/chapter_8/section_1/image31.png" style="width:0.89583in;height:1.46875in" /></td>
...
<tr>
<td><img  src="../_static/media/chapter_8/section_1/image32.png" style="width:1.375in;height:0.57292in" /></td>
<td>Load the data of the saved action group to the action list</td>
</tr>
<tr>
<td><img  src="../_static/media/chapter_8/section_1/image33.png" style="width:1.375in;height:0.5625in" /></td>
<td>Save the current actions in the action list into the designated path.</td>
</tr>
<tr>
<td><img  src="../_static/media/chapter_8/section_1/image34.png" style="width:1.375in;height:0.55208in" /></td>
...
<tr>
<td><img  src="../_static/media/chapter_8/section_1/image35.png" style="width:1.94583in;height:0.39097in" /></td>
<td>Display the saved action groups. You can select the action to run.</td>
</tr>
<tr>
<td><img  src="../_static/media/chapter_8/section_1/image36.png" style="width:0.78125in;height:0.44792in" /></td>
<td>Refresh action group drop-down menu.</td>
</tr>
<tr>
<td><img  src="../_static/media/chapter_8/section_1/image37.png" style="width:1.48958in;height:0.55208in" /></td>
<td>Run the selected action group once.</td>
</tr>
<tr>
<td><img  src="../_static/media/chapter_8/section_1/image38.png" style="width:1.16667in;height:0.54167in" /></td>
<td>Stop running the action group.</td>
</tr>
<tr>
<td><img  src="../_static/media/chapter_8/section_1/image39.png" style="width:1.04167in;height:0.625in" /></td>
...
|                           **Icon**                           |                      **Function**                      |
| :----------------------------------------------------------: | :----------------------------------------------------: |
| <img  src="../_static/media/chapter_8/section_1/image40.png" style="width:1.72917in;height:0.5625in" /> |        Click to read the saved servo deviation.        |
| <img  src="../_static/media/chapter_8/section_1/image41.png" style="width:1.67708in;height:0.5625in" /> | Click to download the adjusted deviation to the robot. |
| <img  src="../_static/media/chapter_8/section_1/image42.png" style="width:1.69792in;height:0.57292in" /> | Click to return all the servos to the mid point(500).  |
...
<img class="common_img" src="../_static/media/chapter_8/section_1/image43.png" />

* **Operation Steps**

(1) Double click <img src="../_static/media/chapter_8/section_1/image44.png" /> to enter PC software interface.

<img class="common_img" src="../_static/media/chapter_8/section_1/image45.png" />

(2) Click "**Open action file**" button.

<img class="common_img" src="../_static/media/chapter_8/section_1/image46.png" />
...
<img class="common_img" src="../_static/media/chapter_8/section_1/image48.png" />
...
<img class="common_img" src="../_static/media/chapter_8/section_1/image49.png" />
...
① Double-click <img src="../_static/media/chapter_8/section_1/image44.png" /> to open the normal mode of the upper computer editing interface.
...
<img class="common_img" src="../_static/media/chapter_8/section_1/image51.png" />
...
<img class="common_img" src="../_static/media/chapter_8/section_1/image58.png" />
...
<img class="common_img" src="../_static/media/chapter_8/section_1/image60.png" />
...
<img class="common_img" src="../_static/media/chapter_8/section_1/image61.png" />
...
<img class="common_img" src="../_static/media/chapter_8/section_1/image62.png" />
...
(1) Double-click <img  src="../_static/media/chapter_8/section_1/image44.png" /> to open the editing interface in normal mode.
...
<img class="common_img" src="../_static/media/chapter_8/section_1/image65.png" style="width:100%;"/>
...
<img class="common_img" src="../_static/media/chapter_8/section_1/image67.png" style="width:100%;" />

(6) Click NO.1 action, then click "**Run**" to let robot arm perform this integrated action.

<img class="common_img" src="../_static/media/chapter_8/section_1/image68.png" />
...
<img class="common_img" src="../_static/media/chapter_8/section_1/image70.png" />
...
(1) Click <img src="../_static/media/chapter_8/section_1/image71.png" />.
...
(3) Double click <img  src="../_static/media/chapter_8/section_1/image76.png" /> to enter PC software interface.

<img class="common_img" src="../_static/media/chapter_8/section_1/image45.png" />

(4) Click "**Open action files**" button. Find the file you just import, and open it.

<img class="common_img" src="../_static/media/chapter_8/section_1/image46.png" style="width:600px;"/>

(5) Next, select the action group you want to execute from the list, and then click '**Open**'.

<img class="common_img" src="../_static/media/chapter_8/section_1/image77.png" style="width:600px;"/>
...
<img class="common_img" src="../_static/media/chapter_8/section_1/image79.png" />

###  8.1.8 Position and Orientation of the Robotic Arm in 3D Space

(1) Double-click <img src="../_static/media/chapter_8/section_1/image5.png" /> to initiate the command-line terminal, and enter the following command to terminate the app auto-start service.

```bash
sudo systemctl stop start_app_node.service
```

(2) Click-on <img src="../_static/media/chapter_8/section_1/image76.png" /> to launch the PC software.

(3) Position and orientation of the robotic arm in 3D space:

<img class="common_img" src="../_static/media/chapter_8/section_1/image81.png" style="width:100%;" />
...
(4) Set the values for X, Y, Z, and pitch as needed. Once you've made the adjustments, click **'Run'** to move the robotic arm to the specified position and orientation in 3D space.
...
<img class="common_img" src="../_static/media/chapter_8/section_2/image2.jpeg" alt="zhi.2" />

<img class="common_img" src="../_static/media/chapter_8/section_2/image3.jpeg" alt="wan.3" />
...
<img src="../_static/media/chapter_8/section_2/image4.png" style="width:24%" />

<img src="../_static/media/chapter_8/section_2/image5.png" style="width:24%;" />

<img src="../_static/media/chapter_8/section_2/image6.png" style="width:24%;" />

<img src="../_static/media/chapter_8/section_2/image7.png" style="width:24%;" />
...
<img class="common_img" src="../_static/media/chapter_8/section_2/image8.png" alt="" />
...
<img class="common_img" src="../_static/media/chapter_8/section_2/image9.png" alt="9" />
...
<img class="common_img" src="../_static/media/chapter_8/section_2/image10.png" alt="10" />
...
<img class="common_img" src="../_static/media/chapter_8/section_2/image11.png" style="width:300px;" />
...
<img class="common_img" src="../_static/media/chapter_8/section_2/image12.png" style="width:550px;" />

The detailed instructions are as below:

(1) Access the robot system. Click-on <img src="../_static/media/chapter_8/section_2/image13.png" /> to open the ROS1 terminal.
...
<img class="common_img" src="../_static/media/chapter_8/section_2/image15.png" />
...
<img class="common_img" src="../_static/media/chapter_8/section_2/image17.png" />
...
<img class="common_img" src="../_static/media/chapter_8/section_2/image19.png" alt="IMG_256" />

(8) You can see that the deviation value for Servo ID: 3 is -18. When Servo 3 has such a deviation, adjustment should be made in the opposite direction until it reaches the "**Standard (1)**" state specified in the "[**8.2.2 Adjustment Steps->Adjustment Standard**](#anchor_8_2_2)."
...
<img class="common_img" src="../_static/media/chapter_8/section_2/image21.png" style="width:160px;" />

(10) Wait for the prompt **"Download Deviation Successful"** to appear, then click **"OK"** to exit the window.

<img class="common_img" src="../_static/media/chapter_8/section_2/image22.png" style="width:160px;" />
...
<img class="common_img" src="../_static/media/chapter_8/section_2/image23.png" style="width:290px;"/>

(12) Choose **'init'**.

<img class="common_img" src="../_static/media/chapter_8/section_2/image24.png" style="width:290px;" />

(13) Click **"Execute Action"** to have the robotic arm perform the **"init"** action group.

<img class="common_img" src="../_static/media/chapter_8/section_2/image25.png" style="width:290px;"/>

After clicking, the robot's status is as shown in the following image:

<img class="common_img" src="../_static/media/chapter_8/section_2/image26.png" alt="9" />
...
<img class="common_img" src="../_static/media/chapter_8/section_3/image2.png" alt="" />
...
(2) Double click on <img src="../_static/media/chapter_8/section_3/image3.png"   /> to open the command line terminal.
...
<img class="common_img" src="../_static/media/chapter_8/section_3/image8.png" alt="" />
...
<img class="common_img" src="../_static/media/chapter_8/section_3/image13.png" alt="" />
...
(2) Double click on <img src="../_static/media/chapter_8/section_3/image3.png" style="width:0.36736in;height:0.30347in" /> to open the command-line terminal.
...
<img class="common_img" src="../_static/media/chapter_8/section_3/image23.png" alt="图片5" />
...
<img class="common_img" src="../_static/media/chapter_8/section_3/image27.png" alt="图片3" />
...
<img class="common_img" src="../_static/media/chapter_8/section_3/image39.png" style="width:5.76389in;height:3.30347in" />

(5) Run the program according to the instructions provided in ["**8.3.3 Color Recognition -> Operation Steps**"](#anchor_8_3_3_2).
...
The source code of the program is stored in: [/home/ubuntu/ros2_ws/src/example/example/color_track/color_track_node.py](../_static/source_code/color_sorting.zip)
...
<img class="common_img" src="../_static/media/chapter_8/section_3/image41.png" />

* **Program Analysis**

(1) Launch analysis:

<img class="common_img" src="../_static/media/chapter_8/section_3/image42.png" alt="" />

Program path: [ros2_ws/src/example/example/color_track/color_track_node.launch.py](../_static/source_code/color_sorting.zip)
...
<img class="common_img" src="../_static/media/chapter_8/section_3/image46.png" alt="" />

Program path:[ros2_ws/src/example/example/color_track/color_track_node.py](../_static/source_code/color_sorting.zip)
...
(2) Double click on <img src="../_static/media/chapter_8/section_3/image3.png" style="width:0.36736in;height:0.30347in" /> to start the command line terminal.
...
<img class="common_img" src="../_static/media/chapter_8/section_3/image53.png" />

(6) After the modification is completed, enter "**:wq**" to save and exit the program file.

<img class="common_img" src="../_static/media/chapter_8/section_3/image54.png" />

(7) Operate the game based on "[**8.3.4 Color Tracking-> Operation Steps**](#anchor_8_3_4_2)".
...
The source code for this program can be found at: [/home/ubuntu/ros2_ws/src/example/example/line_follow_clean/line_follow_clean_node.py](../_static/source_code/line_follow_clean.zip)
...
(2) Double click on <img src="../_static/media/chapter_8/section_3/image3.png" style="width:0.36736in;height:0.30347in" /> to initiate the command line terminal.
...
<img class="common_img" src="../_static/media/chapter_8/section_3/image56.png" />
...
<img class="common_img" src="../_static/media/chapter_8/section_3/image57.png" alt="" />
...
<img class="common_img" src="../_static/media/chapter_8/section_3/image61.png" alt="" />
...
<img class="common_img" src="../_static/media/chapter_8/section_3/image71.png" />

(5) Finally, run the program according to "[**8.3.5 Line-Following Obstacle Clearance -> Operation Steps**](#anchor_8_3_5_2)".
...
<img class="common_img" src="../_static/media/chapter_8/section_3/image73.png" alt="" />
...
<img class="common_img" src="../_static/media/chapter_8/section_3/image77.png" alt="" />
...
(3) Click-on <img src="../_static/media/chapter_8/section_3/image86.png" style="width:0.49861in;height:0.37639in" /> to initiate the command-line terminal.
...
<img class="common_img" src="../_static/media/chapter_8/section_3/image88.png" />
...
<img class="common_img" src="../_static/media/chapter_8/section_3/image89.png" />  
...
<img class="common_img" src="../_static/media/chapter_8/section_3/image90.png" alt="" />
...
<img class="common_img" src="../_static/media/chapter_8/section_3/image93.png" alt="" />
...
```python
    def goal_callback(self, msg):
        ...
        if status == 'start' or status == 'place_finish':   
            self.pick = True
            self.place = False
...
① Start JetAuto and connect it to NoMachine remote control software.

② Click on <img src="../_static/media/chapter_8/section_3/image98.png" style="width:0.38958in;height:0.32917in" /> to open the command line terminal.
...
<img class="common_img" src="../_static/media/chapter_8/section_3/image100.png" />
...
<img class="common_img" src="../_static/media/chapter_8/section_3/image101.png" />

⑥ Upon the completion of the modification, please start the game according to "[**8.3.7 Fixed Point Navigation->Operation Steps**](#anchor_8_3_7_2)".