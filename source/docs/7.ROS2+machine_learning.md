...
<img class="common_img" src="../_static/media/chapter_7/section_2/media/image109.png" />
...
(11) Click <img src="../_static/media/chapter_7/section_2/media/image110.png" style="width:70px;"/>on the system status bar to open the file manager, where you can view the saved images.
...
(11) You can click <img src="../_static/media/chapter_7/section_2/media/image110.png" style="width:70px;"/> on the system status bar to open the file manager and navigate to the directory '/home/ubuntu/my_data/' to view the annotation files for the images.

<img class="common_img" src="../_static/media/chapter_7/section_2/media/image111.png"  />
...
<img class="common_img" src="../_static/media/chapter_7/section_2/media/image112.png" style="width:100%;" />
...
<img class="common_img" src="../_static/media/chapter_7/section_2/media/image113.png" />
...
<img class="common_img" src="../_static/media/chapter_7/section_2/media/image114.png" />
...
<img class="common_img" src="../_static/media/chapter_7/section_2/media/image115.png" />
...
<img class="common_img" src="../_static/media/chapter_7/section_2/media/image116.png" style="width:700px;" />
...
<img class="common_img" src="../_static/media/chapter_7/section_2/media/image117.png" style="width:700px;" />
...
<img class="common_img" src="../_static/media/chapter_7/section_2/media/image118.png"  />
...
③ Click-on <img src="../_static/media/chapter_7/section_2/media/image110.png" style="width:70px;"/> to enter file manager, then locate the designated folder.

<img class="common_img" src="../_static/media/chapter_7/section_2/media/image119.png"  />

④ Right click the file `yolo5v_trt.py`, and select  `Open With Text Editor`.

<img class="common_img" src="../_static/media/chapter_7/section_2/media/image120.png"  />
...
<img class="common_img" src="../_static/media/chapter_7/section_2/media/image122.png"  />
...
<img class="common_img" src="../_static/media/chapter_7/section_2/media/image123.png"  />

<img class="common_img" src="../_static/media/chapter_7/section_2/media/image124.png"  />
...
⑨ Click-on <img src="../_static/media/chapter_7/section_2/media/image110.png" style="width:70px;"/> to open the file manager, and navigate to the folder as pictured, then you can check the saved pictures.

<img class="common_img" src="../_static/media/chapter_7/section_2/media/image131.png" style="width:700px;" alt="" />
...
(12) Click <img src="../_static/media/chapter_7/section_2/media/image78.png" style="width:0.27559in;height:0.28099in" /> in the system status bar to open the file manager. Navigate to the directory "**/home/ubuntu/my_data/Annotations/**" to view the picture annotation file.
...
<img class="common_img" src="../_static/media/chapter_7/section_2/media/image125.png"   />

The modification should be done as shown in the picture.

<img class="common_img" src="../_static/media/chapter_7/section_2/media/image126.png"   />
...
<img class="common_img" src="../_static/media/chapter_7/section_2/media/image127.png"   />
...
(3) Click-on <img src="../_static/media/chapter_7/section_2/media/image110.png" style="width:70px;"/>to navigate to the file manager and direct the designated folder.

<img src="../_static/media/chapter_7/section_2/media/image128.png" />

(4) Right-click the file **'yolo5v_trt.py'** and select **'Open With Text Editor'."**

<img src="../_static/media/chapter_7/section_2/media/image129.png"  />
...
<img src="../_static/media/chapter_7/section_2/media/image130.png"  />
...
⑧ Click-on <img src="../_static/media/chapter_7/section_2/media/image110.png" style="width:70px;"/>  to open the file manager, and navigate to the designated storage path to check the stored pictures.
...
<img class="common_img" src="../_static/media/chapter_7/section_2/media/image132.png" style="" />

After modification:

<img class="common_img" src="../_static/media/chapter_7/section_2/media/image133.png" style="" />
...
<img class="common_img" src="../_static/media/chapter_7/section_2/media/image134.png" style="" />
...
(3) Click-on <img src="../_static/media/chapter_7/section_2/media/image110.png" style="width:70px;"/> to open the file manager, and direct to the designated folder.

<img src="../_static/media/chapter_7/section_2/media/image135.png"  />
...
<img src="../_static/media/chapter_7/section_2/media/image136.png"  />

(6) Click **"Save"** in the top right corner to save the changes.

<img src="../_static/media/chapter_7/section_2/media/image137.png"  />
...
⑨ Click-on  <img src="../_static/media/chapter_7/section_2/media/image138.png" style="width:0.36736in;height:0.30347in" /> to open the file manager, and navigate to the folder as pictured, then you can check the saved pictures.
...
<img class="common_img" src="../_static/media/chapter_7/section_2/media/image139.png"  />

After modification:

<img class="common_img" src="../_static/media/chapter_7/section_2/media/image140.png"  />
...
<img class="common_img" src="../_static/media/chapter_7/section_2/media/image141.png"  />
...
<img src="../_static/media/chapter_7/section_2/media/image142.png"/>

(4) Right-click the file **"yolo5v_trt.py"** and select **"Open With Text Editor."**

<img src="../_static/media/chapter_7/section_2/media/image143.png"/>

(5) In the first red box, enter the names of the objects you want to recognize (delete the original content). In the second red box, enter the name of the trained model in the first parameter field, and the "libmyplugins.so" file in the second parameter field. Rename it here to "libmyplugins_640.so." Adjust based on your file names.

<img src="../_static/media/chapter_7/section_2/media/image144.png"/>

(6) Click "Save" in the top right corner to save the changes.

<img src="../_static/media/chapter_7/section_2/media/image145.png"/>
...
(1) Click <img  src="../_static/media/chapter_7/section_2/media/image33.png" style="width:0.36736in;height:0.30347in" /> on the system desktop to open the command line terminal. Enter the following commands in order to increase the swap memory space:
...
② The road sign model used in this section is trained with YOLOv5. For more details on YOLOv5, please refer to 'ROS+Machine Learning Course\2. Machine Learning**.'
...
The source code for this program can be found at : [/home/ubuntu/ros2_ws/src/example/example/yolov5_detect/yolov5_trt.py](../_static/source_code/yolo_detect.zip)
...
The source code of this program is saved in [/home/ubuntu/ros2_ws/src/example/example/yolov5_detect/yolov5_trt.py](../_static/source_code/yolo_detect.zip)
...
<img class="common_img" src="../_static/media/chapter_7/section_4/media/image56.png" />
...
<img class="common_img" src="../_static/media/chapter_7/section_4/media/image57.png" />
...
①  Ensure correct adjustment of the robot arm deviation. For detailed instructions on robot arm deviation adjustment, please refer to "**[8. ROS2-Robot Arm Control Course](https://docs.hiwonder.com/projects/JetAutoPi/en/latest/docs/8.robot_arm_control.html)**" for comprehensive learning.
