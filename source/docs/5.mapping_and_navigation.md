...
(1) Click-on <img src="../_static/media/chapter_5/section_1/media/image24.png"  /> to initiate the ROS2 command-line terminal.
...
(1) Click on <img src="../_static/media/chapter_5/section_1/media/image24.png"  /> on the system desktop to open the ROS2 command-line terminal. Then run the command to disable the app auto-start service:
...
<img  src="../_static/media/chapter_5/section_2/media/image7.png" style="width:48%;" />
<img  src="../_static/media/chapter_5/section_2/media/image8.png" style="width:48%;" />
</p>
...
<img src="../_static/media/chapter_5/section_2/media/image22.png" style="width:400px;" />

<img src="../_static/media/chapter_5/section_2/media/image23.png"  style="width:400px;" />
...
(1) Click-on <img src="../_static/media/chapter_5/section_2/media/image29.png"  /> to start the command line terminal.Then execute the command to disable the app auto-start service:
...
(2) Click-on <img src="../_static/media/chapter_5/section_2/media/image29.png"  /> to open the command line terminal and Execute the command to disable the app auto-start service:

```bash
sudo systemctl stop start_app_node.service
```

(3)  Create a new command-line terminal, and enter the following command to start the RViz tool for navigation display:
...
(4) Click <img src="../_static/media/chapter_5/section_2/media/image39.png"  />, and on the map interface, select a location as the target point by clicking the mouse once at that point. After the selection is made, the robot will automatically generate a route and move to the target point.
